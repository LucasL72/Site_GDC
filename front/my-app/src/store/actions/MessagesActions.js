...
export const getMessage = (data) => {
  return (dispatch) => {
    ...
    return axios.get("http://localhost:3030/Admin/Messages")
      .then((res) => {
...
export const getMessageID = (id) => {
  return (dispatch) => {
    ...
    return axios.get(`http://localhost:3030/Admin/Messages/${ id }`)
      .then((res) => {
...
export const createMessage = (data) => {
  return (dispatch) => {
    console.log('reducers get messages')
    return axios.post("http://localhost:3030/Contact", data)
      .then((res) => {
...
export const deleteMessage = (id) => {
  return (dispatch) => {
    console.log('reducers get messages')
    return axios.delete(`http://localhost:3030/Admin/Messages/${ id }`)
      .then((res) => {
