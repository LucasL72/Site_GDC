// From https://github.com/bakunya/react-masonry
import { useState, memo, useCallback, useEffect } from "react";
import Masonry from "./Mansonry";
...
const ImageElement = memo(({ value }) => (
  <div style={{ borderRadius: "10px", margin: "5px" }}>
    <img src={value} style={{ width: "100%", borderRadius: "10px" }} alt="titre image"/>
  </div>
));
  ...
  return (
    <div className="App">
      ...
      <div className="text-center mb-3">
        <Button variant="dark" onClick={handleImages}>
